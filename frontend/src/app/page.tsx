        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-1">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li>
                  <a href="mailto:info@onelastai.com" className="hover:text-indigo-600 transition-colors">
            ...
            <div className="md:col-span-1">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li>
                  <a href="mailto:support@onelastai.com" className="hover:text-indigo-600 transition-colors">
                    Support
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            <div className="flex justify-center space-x-6 md:order-2">
              ...
              <a href="mailto:info@onelastai.com" className="text-gray-400 hover:text-indigo-500 transition-colors">
