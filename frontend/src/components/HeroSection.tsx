...
import { Heart, Brain, Sparkles, Robot } from '@phosphor-icons/react'
    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-4 relative">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10 mt-24">
        ...
        >
          ...
          >
            Advanced AI Platform with Specialized Agents for Every Need
          </motion.p>
          ...
          >
            Experience multiple specialized AI agents designed to automate tasks, analyze data, and provide intelligent insights through cutting-edge technology.
          </motion.p>
